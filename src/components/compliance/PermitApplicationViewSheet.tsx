...
import { MapPin, FileText, Shield, Receipt, UserCheck, Loader2 } from 'lucide-react';
...
interface PermitApplicationViewSheetProps {
  open: boolean;
...
export function PermitApplicationViewSheet({ 
  open, 
  onOpenChange, 
  applicationId,
  onUpdate 
}: PermitApplicationViewSheetProps) {
