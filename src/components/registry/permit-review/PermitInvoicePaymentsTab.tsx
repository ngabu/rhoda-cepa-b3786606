      ...
      <CardContent className="space-y-6 pt-6">
        ...
        {invoices.length === 0 ? (
          <div className="text-center py-8 border rounded-lg bg-muted/20">
            ...
            <p className="text-muted-foreground">No invoices found for this permit application</p>
          </div>
        ) : (
          <Table>
            <TableHeader>
                ...
                return (
                  <TableRow key={invoice.id}>
                    ...
                    <TableCell className="max-w-[200px] truncate">
                      {invoice.follow_up_notes || 'Permit Application Fee'}
                    </TableCell>
        ...
        <div className="space-y-2 pt-4 border-t">
          ...
          <Textarea
            ...
            placeholder="Add any remarks about invoices and payments..."
            rows={3}
            disabled={!canEdit}
