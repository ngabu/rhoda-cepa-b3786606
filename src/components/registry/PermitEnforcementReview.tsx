      ...
      {selectedActionData && (
        <>
          ...
          <CEPAInternalReviewTabs
            applicationId={selectedActionData.id}
            applicationType="permit_enforcement"
            applicationNumber={selectedActionData.permitNumber}
            currentStatus={selectedActionData.status}
          />
        </>
      )}
    </>
