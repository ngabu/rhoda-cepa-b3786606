      ...
      {selectedReportData && (
        <>
          ...
          <CEPAInternalReviewTabs
            applicationId={selectedReportData.id}
            applicationType="permit_compliance"
            applicationNumber={selectedReportData.permitNumber}
            currentStatus={selectedReportData.status}
          />
        </>
      )}
    </>
