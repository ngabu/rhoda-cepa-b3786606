...
-- First, remove existing test profiles and auth users if they exist
DELETE FROM public.profiles WHERE email IN (
  'john.smith@example.com', 'mary.johnson@example.com', 'peter.wilson@example.com',
  'sarah.thompson@cepa.gov.pg', 'michael.brown@cepa.gov.pg',
  'lisa.anderson@cepa.gov.pg', 'david.miller@cepa.gov.pg',
  'emma.davis@cepa.gov.pg', 'james.wilson@cepa.gov.pg',
  'rachel.green@cepa.gov.pg', 'kevin.lee@cepa.gov.pg',
  'jennifer.taylor@cepa.gov.pg', 'robert.clark@cepa.gov.pg', 'patricia.williams@cepa.gov.pg',
  'admin@cepa.gov.pg'
);
