-- Update calculate_application_fee to use correct custom processing days based on fee_category
...
COMMENT ON FUNCTION public.calculate_application_fee IS 'Calculates permit application fee based on prescribed activity, permit type, and processing days (30 days for Level 2.1, 88 days for Level 2.2/2.3/2.4, 90 days for Level 3)';