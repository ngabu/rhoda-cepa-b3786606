-- Add LLG column to intent_registrations
ALTER TABLE public.intent_registrations ADD COLUMN IF NOT EXISTS llg text;

-- Add LLG column to intent_registration_drafts
ALTER TABLE public.intent_registration_drafts ADD COLUMN IF NOT EXISTS llg text;

-- Update the RPC function to include llg field
